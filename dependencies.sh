...
install_common_dependencies() {
	...
	sudo apt install -y apt-transport-https build-essential bzip2 curl ca-certificates \
		...
		pkg-config software-properties-common tk-dev wget xz-utils zlib1g-dev universal-ctags libpq-dev \
        cmake g++ libfontconfig1-dev libxcb-xfixes0-dev libxkbcommon-dev python3 || log_error "Failed to install common dependencies."
